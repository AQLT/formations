...
```{r, echo = FALSE}
set.seed(100)
ar1_pos = arima.sim(n=200, list(ar=0.8))
ar1_neg = arima.sim(n=200, list(ar=-0.8))
ar2_pos = arima.sim(n=200, list(ar=c(0.3, 0.2)))
ar2_neg = arima.sim(n=200, list(ar=c(-0.3, 0.2)))
...
- $r(h)$ décroit exponentiellement vers 0 (ou sinusoidale)

- $\rho(h)=0$ pour $h>p$


### Exemples AR(2) $y_t = 0.3y_{t-1}+0.2y_{t-2} + \varepsilon_t$
...
::::{.colums}
:::{.colum width=30%}
Modèle *moyenne mobile* d'ordre $q$, $MA(p)$ :
:::
:::{.colum width=60%}
\vspace{-0.5cm}
\begin{align*}
...
```{r, echo = FALSE}
set.seed(100)
ma1_pos = arima.sim(n=200, list(ma=0.8))
ma1_neg = arima.sim(n=200, list(ma=-0.8))
ma2_pos = arima.sim(n=200, list(ma=c(0.3, 0.2)))
ma2_neg = arima.sim(n=200, list(ma=c(-0.3, 0.2)))
...
- $r(h)=0$ décroit exponentiellement vers 0


### Exemples AR(2) $y_t = 0.3\varepsilon_{t-1}+0.2\varepsilon_{t-2} + \varepsilon_t$
